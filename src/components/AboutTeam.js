    ...
    <div className="team">
      <div className="team_card" tabIndex="0">
        <div className="team_card_inner">
          <div className="team_card_inner_front">
            <div className="image-cropper">
              <img
                className="headshot"
                src={boris}
                alt="headshot of Borinquen 'Boris' Rodriguez"
              ></img>
            </div>
            <h4 className="team_card_inner_front_name">
              Borinquen "Boris" Rodriguez
            </h4>
          </div>
          <div className="team_card_inner_back">
            ...
            <a
              href="https://www.linkedin.com/in/brodri4/"
              target="_blank"
              rel="noreferrer"
            >
              <LinkedinLogo
                className="linkIcon"
                alt="LinkedIn logo link to LinkedIn profile"
              />
            </a>
            <a
              href="https://github.com/brodri4"
              target="_blank"
              rel="noreferrer"
            >
              <GithubLogo
                className="linkIcon"
                alt="Github logo link to github profile"
              />
            </a>
            <a
              href="http://borinquen-rodriguez-portfolio.surge.sh/"
              target="_blank"
              rel="noreferrer"
            >
              <ChromeLogo
                className="linkIcon"
                alt="Chrome logo link to portfolio"
              />
            </a>
            <a
              href="https://twitter.com/Brodri4"
              target="_blank"
              rel="noreferrer"
            >
              <TwitterLogo
                className="linkIcon"
                alt="Twitter logo link to Twitter profile"
              />
            </a>
          </div>
        </div>
      ...
      <div className="team_card" tabIndex="0">
        <div className="team_card_inner">
          ...
          <div className="team_card_inner_back">
            <p>
              Abbey is a passionate Full-Stack Web Developer looking for
              projects with lots of problems to solve.
            </p>
            <a
              href="https://www.linkedin.com/in/abigail-perini/"
              target="_blank"
              rel="noreferrer"
            >
              <LinkedinLogo
            ...
            <a
              href="https://github.com/abbeyperini"
              target="_blank"
              rel="noreferrer"
            >
              <GithubLogo
            ...
            <a
              href="https://abbeyperini.github.io/portfolio.html"
              target="_blank"
              rel="noreferrer"
            >
              <ChromeLogo
            ...
            <a
              href="https://twitter.com/AbbeyPerini"
              target="_blank"
              rel="noreferrer"
            >
              <TwitterLogo
      ...
      <div className="team_card" tabIndex="0">
        <div className="team_card_inner">
          ...
          <div className="team_card_inner_back">
            <p>
              Hung is Game enthusiast turn passionate software programer looking
              to create leading-edge applications
            </p>
            <a
              href="https://www.linkedin.com/in/hungtran0713/"
              target="_blank"
              rel="noreferrer"
            >
              <LinkedinLogo
            ...
            <a
              href="https://hptran7.github.io/Porfolio/"
              target="_blank"
              rel="noreferrer"
            >
              <ChromeLogo
      ...
      <div className="team_card" tabIndex="0">
        <div className="team_card_inner">
          ...
          <div className="team_card_inner_back">
            <p>
              Jonathan is a Full-Stack Web Developer whose always looking for a
              puzzle to solve!
            </p>
            <a
              href="https://www.linkedin.com/in/jonathannuno/"
              target="_blank"
              rel="noreferrer"
            >
              <LinkedinLogo
            ...
            <a
              href="https://github.com/Jonathan-Nuno"
              target="_blank"
              rel="noreferrer"
            >
              <GithubLogo
