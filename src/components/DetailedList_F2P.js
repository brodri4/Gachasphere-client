...
function DetailedList_F2P(props) {
    ...
    if(!props.gameRatings || !props.gameRatings[0]) {
        ...
        return (
            <div className="detailed-list-page">
                <h1 className="heading">My Games - Sorted by Free To Play</h1>
...
export default connect(mapStateToProps, mapDispatchToProps)(DetailedList_F2P);