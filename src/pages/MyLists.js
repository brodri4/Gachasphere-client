...
function MyLists(props) {
    ...
    return (
        <div className='myLists-container'>
            ...
            <NavLink to="/detailed/free-to-play"><button className="heading-button">Free To Play</button></NavLink>
            <FreeToPlayMyLists />
            </div>
            <div className='myLists_gameplay'>
            <NavLink to="/detailed/gameplay"><button className="heading-button">Gameplay</button></NavLink>
            <GameplayMyLists />
            </div>
